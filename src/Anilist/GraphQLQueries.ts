...
export const mangaProgressQuery = `query($id: Int) {
        Media(id: $id) {
            id
            mediaListEntry {
                id
...
export const getMangaProgressQuery = `query($id: Int) {
        Media(id: $id) {
            id
            mediaListEntry {
                id
...
export const saveMangaProgressMutation = `mutation($id: Int, $mediaId: Int, $status: MediaListStatus, $score: Float, $progress: Int, $progressVolumes: Int, $repeat: Int, $notes: String, $private: Boolean, $hiddenFromStatusLists: Boolean) {
...
export const deleteMangaProgressMutation = `mutation($id: Int) {
