...
export function getProxyUser(): string {
	return (Application.getState("proxy_user") as string) ?? "";
}

export function getProxyPass(): string {
...
export function setProxyServer(value: string): void {
	Application.setState(value, "proxy_server");
}

export function setEnableProxyServer(value: boolean): void {
	Application.setState(value, "enable_proxy_server");
}

export function setProxyUser(value: string): void {
	Application.setState(value, "proxy_user");
}

export function setProxyPass(value: string): void {
	Application.setSecureState(value, "proxy_pass");
}

export function setProxyAccess(value: string): void {
...
class State<T> {
	...
	constructor(private form: Form, value: T) {
		this._value = value;
	}
					...
					? [
							Section("hiddenSection", [
								...
								LabelRow("boundLabel", {
									...
									subtitle:
										"This label updates with the input",
									value: this.inputValue.value,
								}),
							]),
