...
var source = (() => {
  ...
  __export(main_exports, {
    Toonily: () => Toonily,
    ToonilyExtension: () => ToonilyExtension
  });
  init_buffer();
  ...
  // src/Toonily/main.ts
  var TOONILY_DOMAIN = "https://toonily.com";
  var ToonilyInterceptor = class extends import_types3.PaperbackInterceptor {
    async interceptRequest(request) {
      request.headers = {
        ...request.headers ?? {},
        ...{
  ...
  var ToonilyExtension = class {
    constructor() {
      ...
      this.mainRequestInterceptor = new ToonilyInterceptor("main");
    ...
    checkCloudflareStatus(status) {
      if (status == 503 || status == 403) {
        throw new import_types3.CloudflareError({ url: TOONILY_DOMAIN, method: "GET" });
      }
    }
